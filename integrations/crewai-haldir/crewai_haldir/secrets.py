"""Access Haldir-stored secrets without exposing them to the LLM."""
...
class HaldirSecrets:
    """Fetch secrets from Haldir's vault with scope enforcement.

    Raw values are wrapped in pydantic.SecretStr so they do not appear
